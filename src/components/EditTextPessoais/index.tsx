...
function EditTextPessoais() {
  ...
  return (
    <RichTextEditor editor={editor} className="Containeer">
      <RichTextEditor.Toolbar sticky stickyOffset={60} className="my-editoor">
        <RichTextEditor.ControlsGroup>
          <RichTextEditor.Bold icon={BoldIcon} className="my-editoor" />
      ...
      <RichTextEditor.Content className="Teste" />
    </RichTextEditor>
  )
}
export default EditTextPessoais
